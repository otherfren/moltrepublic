...
NO_BARE_SCAN_FILES = {
    ...
    "docs_archive/reviews/agent_wiki_round_3/friction-right.md": "a seat's friction log: wiki paths and its own friction.md",
    "docs_archive/reviews/agent_wiki_round_3/report-left.md": "a seat's final report: wiki paths and its friction log",
    "docs_archive/reviews/agent_wiki_round_3/report-center.md": "a seat's final report: wiki paths and its friction log",
    "docs_archive/reviews/agent_wiki_round_3/report-right.md": "a seat's final report: wiki paths and its friction log",
    "crates/molt-core/src/wiki_refs.rs": "the reference parser's fixtures are wiki paths",
    ...
    "docs_archive/reviews/mcp_agent_friction_2026-09-06.md": "quoted wiki paths from the second run",
    "docs_archive/reviews/agent_wiki_round_2_briefing.md": "the agents' friction.md scratch file",
}
