...
//! Design: `docs_archive/build/concept-config-bidirection.md`.
//!
...
pub(crate) fn file_settings(s: &SessionSettings, language: &str, theme: &str) -> Settings {
    Settings {
        ...
        s3_max_bytes: s.s3_max_bytes,
        media_s3_bucket: s.media_s3_bucket.clone(),
        media_s3_max_bytes: s.media_s3_max_bytes,
        file_cap_bytes: s.file_cap_bytes,
        mirror_publish_interval_secs: s.mirror_publish_interval_secs,
        mirror_daily_bytes: s.mirror_daily_bytes,
        sound_message: s.sound_message.clone(),
        sound_vote: s.sound_vote.clone(),
        sound_poke: s.sound_poke.clone(),
        poke_enabled: s.poke_enabled,
        poke_wake_command: s.poke_wake_command.clone(),
        ...
        mcp_read_token: s.mcp_read_token.clone(),
