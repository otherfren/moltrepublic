...
pub(crate) fn localize_error(lang: i32, e: &molt_core::MoltError) -> String {
    ...
    match e {
        ...
        E::ChainLagging { peers_ahead } => {
            format!("Die anderen sind {peers_ahead} Block/Blöcke voraus - diese Stimme zählt nicht")
        }
...
lexicon! {
    ...
    mem_toast_vote_queued: "Reading the ratified text - the vote follows", "Der ratifizierte Text wird gelesen - der Vote folgt";
    mem_toast_content_failed: "Ratified text unreadable - vote not started", "Ratifizierter Text nicht lesbar - Vote nicht gestartet";
