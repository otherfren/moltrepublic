...
// Until the tests move to src/tests/, they resolve the crate's items
// through the root, as they did when everything lived here.
#[cfg(test)]
...
#[cfg(test)]
use molt_core::{Command, SessionScope, SessionSettings};
#[cfg(test)]
