...
use molt_core::{
    ChannelRef, Command, Event, MessageId, ProposalId, Reply, SessionScope, SessionSettings, Surface,
};
...
mod tests {
    ...
    use molt_core::{ChannelInfo, ChatMessage, ProposalState, ProposalView, SessionView};
