...
use molt_core::{Command, Event, ProposalId, Reply, SessionScope, SessionSettings, Surface};
...
mod tests {
    ...
    use molt_core::{
        ChannelInfo, ChannelRef, ChatMessage, MessageId, ProposalState, ProposalView, SessionView,
    };
