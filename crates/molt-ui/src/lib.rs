...
use molt_core::{
    ChannelRef, Command, Event, MessageId, ProposalId,
    ProposalView, Reply, SessionScope, SessionSettings, SessionView, Surface,
    SurfaceSnapshot,
};
...
mod tests {
    ...
    use super::*;
    use molt_core::{ChannelInfo, ChatMessage, ProposalState};
