...
> (`docs_archive/transport/nostr_transport_marmot.md`), and the N-queue redundancy
...
Read `docs_archive/transport/mesh/mesh_reliability.md` (Track B) and the CLAUDE.md transport
