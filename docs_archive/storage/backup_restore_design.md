...
(report: `docs_archive/ui/mock_todo.md`); this document remains the design
authority for the shipped export/at-rest/S3-backup/restore behaviour.

Design doc for the security-critical storage stories of `docs_archive/ui/mock_todo.md`:
